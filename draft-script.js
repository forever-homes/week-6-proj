...
function initialize() {
    ...
    // Multiple Markers
    markers = [
        ["Abbey Cat Adoptions" , 43.662,-79.468],
        ["SOS Quebec Ontario Dog rescue", 43.659,-79.433]
    ];

    // var lat = parseInt(app.shelters.lat);
    // var lon = parseInt(app.shelters.lon);

    // for (var i = 0; i < app.shelters.length; i++) {
    //     markers.push(app.shelters[i].shelterName);
    // }
